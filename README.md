...
- **Sensores não respondem**: Confirme conexões I2C e endereços
- **Display em branco**: Verifique alimentação e barramento I2C1
- **LEDs não acendem**: Confirme alimentação 5V na matriz de LEDs
- **Sem alertas**: Verifique se os limites estão configurados corretamente